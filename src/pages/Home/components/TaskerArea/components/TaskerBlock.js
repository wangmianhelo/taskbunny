...
class TaskerBlock extends Component {
    render(){
        return (
            <TaskerBlockWrapper>
               <TaskerSpec>
                   <TaskerName>Brende</TaskerName>
                   <TaskerSpecicalize>Specialities: handyman, electrician, delivery. <br/><br/> A sparky by trade, Brendon jumped onboard when he went back to studying. Here's how Airtasker fit in with his busy lifestyle...</TaskerSpecicalize>
                </TaskerSpec>
